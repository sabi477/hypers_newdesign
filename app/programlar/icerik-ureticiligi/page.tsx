  ...
  return (
    <main className="min-h-screen bg-[#fcfcfc] dark:bg-[#0a0a0a] pt-32 px-6 md:px-24 lg:px-40 pb-20 transition-colors duration-300 relative overflow-x-hidden">
      ...
      <div className="mb-20 text-center relative z-10">
        ...
        <p className="text-[10px] md:text-sm font-bold opacity-30 uppercase tracking-[0.3em] mb-8">Dijital içerik dünyasında uzmanlaş ve kendi markanı inşa et.</p>
      </div>
          ...
          >
            {filteredPrograms.map((prog) => (
              <Link key={prog.id} href={`/program/${prog.id}`} className="h-full p-4 -m-4">
                <div className="group p-[1.5px] rounded-[3rem] relative overflow-hidden flex flex-col h-full shadow-xl hover:shadow-tomato-500/20 transition-all duration-500 transform-gpu">
                  {/* Gradient Border */}
