...
import { MoveRight, ChevronRight, User as UserIcon, Mail, Lock, Sparkles, Check, Eye, EyeOff } from 'lucide-react';
...
export default function RegisterPage() {
  ...
  const validatePassword = (password: string) => {
    if (password.length < 8) return 'ŞİFRE EN AZ 8 KARAKTER OLMALIDIR.';
    if (!/[A-Z]/.test(password)) return 'ŞİFRE EN AZ BİR BÜYÜK HARF İÇERMELİDİR.';
    if (!/[0-9]/.test(password)) return 'ŞİFRE EN AZ BİR RAKAM İÇERMELİDİR.';
    if (!/[!@#$%^&*]/.test(password)) return 'ŞİFRE EN AZ BİR ÖZEL KARAKTER İÇERMELİDİR (!@#$%^&*).';
    return null;
  };
          ...
          >
            ...
            <form className="space-y-5 relative z-10" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2 relative">
                ...
                <p className="text-[8px] font-bold opacity-20 uppercase tracking-widest px-2 pt-1">
                  En az 8 karakter, büyük harf, rakam ve özel karakter gereklidir.
                </p>
              </div>
