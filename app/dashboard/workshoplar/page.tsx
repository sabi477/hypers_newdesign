  ...
  return (
    <div className="max-w-4xl mx-auto py-12 space-y-12">
      <div className="space-y-4">
        <h1 className="text-4xl font-bold tracking-tight">Workshoplar</h1>
        <p className="text-sm opacity-40 font-medium">Katıldığın ve yaklaşan workshop oturumları.</p>
      </div>
      ...
      <div className="p-20 rounded-[3rem] border-2 border-dashed border-black/5 dark:border-white/5 flex flex-col items-center text-center space-y-8">
        ...
        <div className="space-y-3">
          <h2 className="text-2xl font-bold opacity-40">Kayıtlı workshop bulunamadı</h2>
          <p className="text-xs font-bold opacity-20 uppercase tracking-[0.2em] max-w-sm mx-auto leading-relaxed">
            Güncel workshop takvimine göz atarak ilgini çeken oturumlara kayıt olabilirsin.
          </p>
        </div>
        <Link 
